...
{
    [TestClass]
    public class Live_MarketsClientTests : BaseTest
    {
        [TestMethod]
        public void Live_Markets_GetAllMarketsAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetMarketDetailAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetPriceAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetSummaryAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetTradesAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetTradesAsync_Since()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetTradesAsync_Limit()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetTradesAsync_Limit_Since()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetOrderBookAsync()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetOhlcAsync()
        {
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(13, result.Keys.Count);
            Assert.AreEqual(13, result.Values.Count);
        ...
        [TestMethod]
        public void Live_Markets_GetOhlcAsync_Periods()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetOhlcAsync_Before()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetOhlcAsync_After()
        {
        ...
        [TestMethod]
        public void Live_Markets_GetOhlcAsync_BeforeAfter()
        {
            long after = DateTime.UtcNow.AddHours(-1).GetUnixTimeStamp();
            long before = DateTime.UtcNow.AddHours(-0.5).GetUnixTimeStamp();
